...
particle dec:steel_battleaxe_ring_particle ~~0.5~
damage @e[tag=!steel_battleaxe_skill,type=!item,x=~,y=~,z=~1,r=1.3] 5 entity_attack entity @s
damage @e[tag=!steel_battleaxe_skill,type=!item,x=~,y=~,z=~-1,r=1.3] 5 entity_attack entity @s
damage @e[tag=!steel_battleaxe_skill,type=!item,x=~1,y=~,z=~,r=1.3] 5 entity_attack entity @s
damage @e[tag=!steel_battleaxe_skill,type=!item,x=~-1,y=~,z=~,r=1.3] 5 entity_attack entity @s
