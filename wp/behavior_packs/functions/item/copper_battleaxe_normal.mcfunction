...
particle dec:copper_battleaxe_ring_particle ~~0.5~
damage @e[tag=!copper_battleaxe_skill,type=!item,x=~,y=~,z=~1,r=1.3] 3 entity_attack entity @s
damage @e[tag=!copper_battleaxe_skill,type=!item,x=~,y=~,z=~-1,r=1.3] 3 entity_attack entity @s
damage @e[tag=!copper_battleaxe_skill,type=!item,x=~1,y=~,z=~,r=1.3] 3 entity_attack entity @s
damage @e[tag=!copper_battleaxe_skill,type=!item,x=~-1,y=~,z=~,r=1.3] 3 entity_attack entity @s
