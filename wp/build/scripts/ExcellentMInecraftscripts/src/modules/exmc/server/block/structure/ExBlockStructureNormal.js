...
ExBlockStructureNormal.DIRECTION_SOUTH = 2 ** 0;
ExBlockStructureNormal.DIRECTION_NORTH = 2 ** 1;
ExBlockStructureNormal.DIRECTION_EAST = 2 ** 2;
ExBlockStructureNormal.DIRECTION_WEST = 2 ** 3;
ExBlockStructureNormal.DIRECTION_UP = 2 ** 4;
ExBlockStructureNormal.DIRECTION_BUTTOM = 2 ** 5;
ExBlockStructureNormal.DIRECTION_ALLOW_ROTATE = 2 ** 6;
