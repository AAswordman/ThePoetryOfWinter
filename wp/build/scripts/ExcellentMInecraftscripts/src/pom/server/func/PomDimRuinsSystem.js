    ...
    onJoin() {
        ...
        this.getEvents().exEvents.onLongTick.subscribe(event => {
            ...
            if (!PomBossBarrier.isInBarrier(this.player)) {
                this.desertRuinBackJudge.upDate((this.client.getServer().ruin_desertBoss.getBossSpawnArea()?.contains(tmpV) ?? false)
                    && this.player.dimension.id === MinecraftDimensionTypes.theEnd);
                this.stoneRuinBackJudge.upDate((this.client.getServer().ruin_stoneBoss.getBossSpawnArea()?.contains(tmpV) ?? false)
                    && this.player.dimension.id === MinecraftDimensionTypes.theEnd);
                this.caveRuinBackJudge.upDate((this.client.getServer().ruin_caveBoss.getBossSpawnArea()?.contains(tmpV) ?? false)
                    && this.player.dimension.id === MinecraftDimensionTypes.theEnd);
                this.ancientRuinBackJudge.upDate((this.client.getServer().ruin_ancientBoss.getBossSpawnArea()?.contains(tmpV) ?? false)
                    && this.player.dimension.id === MinecraftDimensionTypes.theEnd);
                this.mindRuinBackJudge.upDate((this.client.getServer().ruin_mindBoss.getBossSpawnArea()?.contains(tmpV) ?? false)
                    && this.player.dimension.id === MinecraftDimensionTypes.theEnd);
            }
