...
class CrossValidate {
    ...
    testPartition(trainOpts, trainSet, testSet) {
        ...
        return Object.assign(Object.assign({}, testStats), { trainTime: beginTest - beginTrain, testTime: endTest - beginTest, iterations: trainingStats.iterations, error: trainingStats.error, total: testStats.total, network: classifier.toJSON() });
    }
    /**
...
class BaseLayer {
    constructor(settings) {
        ...
        if (settings) {
            this.settings = Object.assign(Object.assign({}, baseLayerDefaultSettings), settings);
        }
        else {
            this.settings = Object.assign({}, baseLayerDefaultSettings);
        }
        this.setupPraxis();
    }
    get width() {
...
class Modifier extends BaseLayer {
    constructor(inputLayer, settings) {
        super(Object.assign(Object.assign({}, settings), { width: inputLayer.width, height: inputLayer.height, depth: inputLayer.depth }));
        this.inputLayer = inputLayer;
    }
    validate() {
        var _a;
...
class ArthurDeviationBiases extends BasePraxis {
    constructor(layer, settings) {
        super(layer);
        this.settings = Object.assign(Object.assign({}, defaultSettings$1), settings);
        this.kernel = null;
    }
    run(layer) {
...
class MomentumRootMeanSquaredPropagation extends BasePraxis {
    constructor(layerTemplate, settings = {}) {
        super(layerTemplate);
        this.kernelMap = null;
        this.settings = Object.assign(Object.assign({}, defaults$8), settings);
...
const defaults$7 = Object.assign(Object.assign({}, baseLayerDefaultSettings), { std: null });
class Random extends Model {
    constructor(settings) {
        super();
        this.settings = Object.assign(Object.assign({}, defaults$7), settings);
        this.setupPraxis();
        this.validate();
        if (!this.weights) {
...
class Multiply extends Operator {
    ...
    setupPraxis() { }
    toJSON() {
        return Object.assign(Object.assign({}, super.toJSON()), { width: this.width, height: this.height });
    }
}
...
class Convolution extends Filter {
    constructor(settings, inputLayer) {
        ...
        this.settings = Object.assign(Object.assign(Object.assign(Object.assign({}, defaults$6), settings), getPadding(settings, defaults$6)), getStride(settings, defaults$6));
...
const dropoutDefaults = Object.assign(Object.assign({}, baseLayerDefaultSettings), { probability: 0.5 });
class Dropout extends Filter {
    constructor(inputLayer, settings) {
        super(settings, inputLayer);
        this.predictKernelMap = null;
        this.settings = Object.assign(Object.assign({}, dropoutDefaults), settings);
        this.dropouts = null;
        this.validate();
    }
    setupKernels(isTraining) {
...
class Input extends EntryPoint {
    constructor(settings) {
        super(Object.assign(Object.assign({}, defaults$5), settings));
...
function output(settings, inputLayer) {
    ...
    return target(Object.assign({ id: 'target' }, settings), add$1(outputGateConnector, output));
}
...
class Pool extends Filter {
    constructor(settings, inputLayer) {
        super(settings, inputLayer);
        this.predictKernelMap = null;
        this.settings = Object.assign(Object.assign(Object.assign({}, settings), getStride(settings, defaults$4)), getPadding(settings, defaults$4));
        this.weights = randos3D(this.width, this.height, this.depth);
        this.deltas = zeros3D(this.width, this.height, this.depth);
...
class RecurrentZeros extends Internal {
    ...
    setDimensions(width, height) {
        this.praxis = null;
        this.settings = Object.assign(Object.assign({}, this.settings), { width,
            height, weights: zeros2D(width, height), deltas: zeros2D(width, height) });
    }
    setupKernels() {
        // throw new Error(
        //   `${this.constructor.name}-setupKernels is not yet implemented`
...
class FeedForward {
    constructor(options = {}) {
        ...
        this.options = Object.assign(Object.assign({}, defaults$3), options);
        this._updateTrainingOptions(Object.assign(Object.assign({}, trainDefaults$3), options));
    }
    ...
    _updateTrainingOptions(opts) {
        var _a;
        this.trainOpts = Object.assign(Object.assign(Object.assign({}, trainDefaults$3), this.trainOpts), opts);
    ...
    static fromJSON(json, getLayer) {
        ...
        return new this(Object.assign(Object.assign({}, json), { layers }));
    }
    /**
     *
     * @returns {Function}
...
class NeuralNetwork {
    ...
    updateTrainingOptions(trainOpts) {
        const merged = Object.assign(Object.assign({}, this.trainOpts), trainOpts);
    ...
    toJSON() {
        ...
        return {
            ...
            sizes: [...this.sizes],
            layers: jsonLayers,
            inputLookup: this.inputLookup ? Object.assign({}, this.inputLookup) : null,
            inputLookupLength: this.inputLookupLength,
            outputLookup: this.outputLookup ? Object.assign({}, this.outputLookup) : null,
    ...
    fromJSON(json) {
        this.options = Object.assign(Object.assign({}, defaults$2()), json.options);
        if (json.hasOwnProperty('trainOpts')) {
            const trainOpts = Object.assign(Object.assign({}, json.trainOpts), { timeout: json.trainOpts.timeout === 'Infinity'
                    ? Infinity
        ...
        this.initialize();
        this.inputLookup = json.inputLookup ? Object.assign({}, json.inputLookup) : null;
        this.inputLookupLength = json.inputLookupLength;
        this.outputLookup = json.outputLookup ? Object.assign({}, json.outputLookup) : null;
...
class Recurrent extends FeedForward {
    ...
    _connectLayersDeep() {
        ...
        function layerSettings(layer) {
            return Object.assign(Object.assign({}, layer.settings), { weights: null, deltas: null, praxis: null });
        }
...
class RNN {
    constructor(options = {}) {
        ...
        this.trainOpts = Object.assign({}, trainDefaults$1);
        this.stepCache = {};
        this.runs = 0;
        this.ratioClipped = 0;
        ...
        this.options = Object.assign(Object.assign({}, this.options), options);
        this.updateTrainingOptions(Object.assign({}, trainDefaults$1));
        if (options.json) {
    ...
    updateTrainingOptions(options) {
        var _a;
        this.trainOpts = Object.assign(Object.assign({}, trainDefaults$1), options);
    ...
    train(data, trainOpts = {}) {
        var _a;
        this.trainOpts = trainOpts = Object.assign(Object.assign({}, trainDefaults$1), trainOpts);
    ...
    toJSON() {
        ...
        return {
            type: this.constructor.name,
            options: Object.assign(Object.assign({}, options), { dataFormatter: options.dataFormatter.toJSON() }),
            trainOpts: Object.assign(Object.assign({}, this.trainOpts), { timeout: this.trainOpts.timeout === Infinity
                    ? 'Infinity'
    ...
    fromJSON(json) {
        ...
        if (options.dataFormatter) {
            this.options = Object.assign(Object.assign(Object.assign({}, defaults$1()), options), { dataFormatter: DataFormatter.fromJSON(options.dataFormatter) });
        }
        else {
            this.options = Object.assign(Object.assign(Object.assign({}, defaults$1()), options), { dataFormatter: new DataFormatter() });
        }
        this.model = Object.seal({
            isInitialized: true,
            input,
...
const defaults = () => {
    return Object.assign(Object.assign({}, defaults$1()), { inputSize: 1, hiddenLayers: [20], outputSize: 1, inputRange: 0 });
};
class RNNTimeStep extends RNN {
    constructor(options = {}) {
        ...
        this.options = Object.assign(Object.assign({}, this.options), options);
        this.updateTrainingOptions(Object.assign(Object.assign({}, trainDefaults), options));
        if (options.json) {
            this.fromJSON(options.json);
        }
    }
    ...
    setSize(data) {
        ...
        this.options = Object.seal(Object.assign(Object.assign({}, this.options), { inputSize: size, outputSize: size }));
    }
    verifySize() {
    ...
    toJSON() {
        ...
        const { model } = this;
        const options = Object.assign(Object.assign({}, this.options), defaults$1);
        return {
            type: this.constructor.name,
            options,
            hiddenLayers: model.hiddenLayers.map((hiddenLayer) => {
...
const trainDefaults = Object.assign({}, trainDefaults$1);
        ...
        for (let row = 0; row < size; row++) {
            if (column === 0) {
                ...
                for (let previousConnectionIndex = 0; previousConnectionIndex < previousSize; previousConnectionIndex++) {
                    svg += drawBackwardConnections(Object.assign({ pixelX,
                        pixelY,
                        row,
                        column,
                        lineY,
                        previousConnectionIndex }, options));
                }
            }
        }
    }
...
function toSVG(net, options) {
    ...
    // handle json, recurrent first
        ...
        return wrapOuterSVG(rnnToInnerSVG(Object.assign(Object.assign({}, mergedOptions), { sizes: checkSizes(getRNNSizes(net), inputs.labels) })), width, height);
    }
    // handle json, NeuralNetwork
        ...
        switch (net.type) {
            ...
            case 'NeuralNetworkGPU':
                return wrapOuterSVG(neuralNetworkToInnerSVG(Object.assign(Object.assign({}, mergedOptions), { sizes: checkSizes(getNeuralNetworkJSONSizes(net), inputs.labels) })), width, height);
            case 'RNN':
            case 'GRU':
            case 'LSTM':
            case 'RNNTimeStep':
    ...
    return wrapOuterSVG(neuralNetworkToInnerSVG(Object.assign(Object.assign({}, mergedOptions), { sizes: checkSizes(sizes, inputs.labels) })), width, height);
}
