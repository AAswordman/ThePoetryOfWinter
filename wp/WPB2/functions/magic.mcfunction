...
execute positioned as @a[scores={tens=..1}] run scoreboard objectives remove magicdisplay
scoreboard players set @a[scores={tens=..1}] tens 20
scoreboard objectives add magicdisplay dummy §bwbfl§r
execute positioned as @a run scoreboard players operation @s magicdisplay = @s wbfl
execute positioned as @a[tag=display_on] run scoreboard objectives setdisplay sidebar magicdisplay
...
##消耗魔法重置魔法计时
execute positioned as @a[scores={magicreckontimer=0}] run scoreboard players operation @s wbflmirror = @s wbfl
scoreboard players add @a[scores={magicreckontimer=..1}] magicreckontimer 1
execute positioned as @a[scores={magicreckontimer=2}] run scoreboard players operation @s wbflmirror -= @s wbfl
execute positioned as @a[scores={wbflmirror=1..,magicreckontimer=2}] run scoreboard players set @s magicreckon 0
execute positioned as @a[scores={wbflmirror=1..,magicreckontimer=2}] run particle dec:magic_decrease_particle ~~~
