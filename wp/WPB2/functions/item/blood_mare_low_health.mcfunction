...
execute positioned ^^^1 if entity @e[tag=!blood_mare_skill,type=!item,r=1.3] run effect @s regeneration 3 1
execute positioned ^^^1 run damage @e[tag=!blood_mare_skill,type=!item,r=1.3] 7 entity_attack entity @s
