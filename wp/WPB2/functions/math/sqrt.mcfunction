...
execute positioned as @e[type=minecraft:armor_stand,name=运算] run scoreboard players operation @s input *= @s hd
...
execute positioned as @e[type=minecraft:armor_stand,name=运算,scores={judge=0}] run tag @s add ok
execute positioned as @e[type=minecraft:armor_stand,name=运算,scores={judge=!0}] run scoreboard players operation @s data /= @s two
execute positioned as @e[type=minecraft:armor_stand,name=运算,scores={judge=1..}] run scoreboard players operation @s return -= @s data
execute positioned as @e[type=minecraft:armor_stand,name=运算,scores={judge=..-1}] run scoreboard players operation @s return += @s data
...
execute positioned as @e[type=minecraft:armor_stand,name=运算] run scoreboard players operation @s decimal = @s return
execute positioned as @e[type=minecraft:armor_stand,name=运算] run scoreboard players operation @s decimal /= @s hdx
execute positioned as @e[type=minecraft:armor_stand,name=运算] run scoreboard players operation @s decimal *= @s hdx
execute positioned as @e[type=minecraft:armor_stand,name=运算] run scoreboard players operation @s return -= @s decimal
execute positioned as @e[type=minecraft:armor_stand,name=运算] run scoreboard players operation @s decimal >< @s return
execute positioned as @e[type=minecraft:armor_stand,name=运算] run scoreboard players operation @s return /= @s hdx
